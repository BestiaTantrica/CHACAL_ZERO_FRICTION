...
// Import tools
const analyze_strategy_js_1 = require("./analyze-strategy.js");
const freqtrade_api_js_1 = require("./freqtrade-api.js");
const docker_freqtrade_js_1 = require("./docker-freqtrade.js");
const market_data_js_1 = require("./market-data.js");
const risk_manager_js_1 = require("./risk-manager.js");
const groq_bridge_js_1 = require("./groq-bridge.js");
async function main() {
    ...
    server.setRequestHandler(types_js_1.CallToolRequestSchema, async (request) => {
        ...
        switch (name) {
            ...
            case 'groq_intel_analysis':
                return await (0, groq_bridge_js_1.groqAnalysisTool)(args);
