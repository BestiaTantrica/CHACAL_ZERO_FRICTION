...
║  [2] BEAR NORMAL → BTC bajo EMA50 con vol activa| Estándar, ADN Época 46   ║
║  [0] FUERA       → BTC fuera de contexto Bear   | No operamos              ║
║                                                                              ║
...
class ChacalTripleMode(IStrategy):
    ...
    # =========================================================================
    # PARÁMETROS MAESTROS — SELECTOR DE RÉGIMEN DUAL (SUPER/BEAR)
    # =========================================================================
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        bear_thresh = self.bear_rsi.value          # referencia histórica conservada

        bear_active = dataframe['master_bear_switch'] == 1
        btc_rsi     = dataframe['btc_rsi_1h']

        dataframe['market_regime'] = 0  # [0] Fuera

        # [2] BEAR NORMAL: Bear activo y no hay pánico extremo
        dataframe.loc[
            bear_active & (btc_rsi >= sb_thresh),
            'market_regime'
        ] = 2

        # [2] BEAR NORMAL: RSI entre super_bear_rsi y bear_rsi (referencia histórica)
        dataframe.loc[
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        # Aplicar señales (prioridad: Super Bear > Bear Normal)
        force_suffix = ''
    ...
    def custom_stoploss(self, pair: str, trade: 'Trade', current_time: datetime,
        ...
        sl_mult = {3: 1.15, 2: 1.00}.get(regime, 1.00)
    ...
    def custom_exit(self, pair: str, trade: 'Trade', current_time: datetime,
        ...
        roi_mult = {3: 1.20, 2: 1.00}.get(regime, 1.00)
        roi_target = max(
        ...
        # Umbrales de rebote → más tolerante en Super Bear
        if regime == 3:   # SUPER BEAR: aguanta más el rebote
            ...
            rebound_thresh = self.bear_rebound_thresh.value * (1.05 - 0.15 * frps)
            rsi_exit_1m = 76 - int(frps * 5)
        ...
        timeout_mult = {3: 1.20, 2: 1.00}.get(regime, 1.00)
