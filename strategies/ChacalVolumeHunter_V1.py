...
class ChacalVolumeHunter_V1(IStrategy):
    ...
    trailing_stop = True
    trailing_stop_positive = 0.005         # Persigue el precio dejándole un 0.5% de aire para respirar
    trailing_stop_positive_offset = 0.025  # Se activa SÓLO cuando ya ganamos un +2.5%
    trailing_only_offset_is_reached = True # Prohibido aplicar trailing en pérdidas
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        # --- TIME GUARD: 06-20 UTC (sleep safe hours) ---
    ...
    def adjust_trade_position(self, trade: Trade, current_time: datetime,
        ...
        if not self.dca_enabled or current_profit > -0.04: # Esperamos un 4% de caída para DCA
            return None
