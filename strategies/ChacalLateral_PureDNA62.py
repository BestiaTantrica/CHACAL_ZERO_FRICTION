...
class ChacalLateral_PureDNA62(IStrategy):
    """
    ESTRATEGIA CHACAL LATERAL - PURE DNA 62 (The Original +10% Profit)
    Esta versión elimina el ruido de 1m para estabilizar la operativa en AWS.
    El refinamiento micro se delega a la IA Cuántica.
    """
    INTERFACE_VERSION = 3
    can_short = True
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        # Macro BTC 1h: Solo operamos si BTC está "lateral" respecto a su propia EMA50
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        # ENTRADA PURA 5m: Reversión a la media en bandas de Bollinger
        long_cond = (
        ...
        dataframe.loc[long_cond, ['enter_long', 'enter_tag']] = [1, 'LAT_LONG_PURE']
        dataframe.loc[short_cond, ['enter_short', 'enter_tag']] = [1, 'LAT_SHORT_PURE']
        return dataframe
    ...
    def custom_exit(self, pair, trade, current_time, current_rate, current_profit, **kwargs):
        ...
        # Gestión Anti-Zombies (6h)
        trade_duration = (current_time - trade.open_date_utc).total_seconds() / 3600
        if trade_duration > 6.0: return 'TIME_EXIT_6H'
        
        # TARGET MID: Salimos en la media siempre que haya profit (Garantiza el 80% WinRate en lateral)
        ...
        # Safety: Si el mercado deja de ser lateral (Breakout de BTC), abortamos
    ...
    def custom_stoploss(self, pair: str, trade: Trade, current_time: datetime,
        ...
        # Blindaje contra Trailing Stop: Stop Loss fijo al 5%
