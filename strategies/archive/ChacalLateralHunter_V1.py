...
class ChacalLateralHunter_V1(IStrategy):
    ...
    # --- BLOQUEO TOTAL DE TRAILING STOP (EXTERMINIO) ---
    trailing_stop = False 
    ...
    stoploss = -0.05 
    timeframe = '5m'
    minimal_roi = {"0": 100} # ROI inalcanzable para que mande el TARGET_MID
    max_open_trades = 8
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        # Cascada Nivel 2: Filtros de Calidad 5m
    ...
    def custom_exit(self, pair, trade, current_time, current_rate, current_profit, **kwargs):
        ...
        # --- GESTIÓN DE TIEMPO (CORTA EL DRENAJE ZOMBIE) ---
        trade_duration = (current_time - trade.open_date_utc).total_seconds() / 3600
        if trade_duration > 6.0: return 'TIME_EXIT_6H'
        
        # --- SALIDA POR TARGET (MEDIA BB) ---
    ...
    def custom_stoploss(self, pair: str, trade: Trade, current_time: datetime,
        ...
        # ESTE ES EL BLINDAJE FINAL: SI NO ES TARGET_MID, NO SE SALE SI NO ES -5%
        # DEVOLVER UN VALOR CONSTANTE PARA QUE EL TRAILING NO PUEDA AJUSTAR NADA
